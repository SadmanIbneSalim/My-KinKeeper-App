...
const SummaryCards = () => {
  return (
    <div className="bg-base-200 pb-10 ">
      <div className="max-w-277.5 mx-3  md:mx-auto grid grid-cols-2 lg:grid-cols-4 gap-2 ">
        <div className="bg-white  md:max-w-100   py-8 shadow rounded-xl text-center flex justify-center items-center">
          <div>
